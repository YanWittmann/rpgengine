public class LootTable extends Entity{
    ...
    public LootTable(String[] fileInput){
        ...
        }catch(Exception e){Popup.error(StaticStuff.PROJECT_NAME, "LootTable '"+name+"' contains invalid data.");}
    }
    ...
    public void openEditor(){
        new GuiEntityEditor(this, new String[]{"Name","Description","Add event","Edit event","Remove event","Edit tags","Edit variables","Edit loot table"},"LootTable"){
            @Override
            public void buttonPressed(int index){
                ...
                switch(index){
                    ...
                    break;
                    case 7:
                    new GuiActionEditor((LootTable)getEntity(),((LootTable)getEntity()).getDropIndex());
                    break;
                    default:
