...
public class Popup {
    ...
    public static AdventureSearchResult dropDown(String title, String message, AdventureSearchResult[] choice) {
        return (AdventureSearchResult) JOptionPane.showInputDialog(null, message, title, JOptionPane.PLAIN_MESSAGE, null, choice, choice[0]);
    }
